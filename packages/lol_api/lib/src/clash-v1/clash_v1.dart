...
class ClashV1 {
  ...
  static Future<List<PlayerDTO>> getPlayersByPuuid(
    RegionValues region,
    String puuid, {
    Map<String, String>? headers,
  }) async {
    final url =
        '${region.regionToUrl}/${Qtype.lol.name}/clash/v1/players/by-puuid/${Uri.encodeComponent(puuid)}';
  ...
  /// Get team by ID
  static Future<TeamDTO> getTeamById(
    RegionValues region,
    String teamId, {
    Map<String, String>? headers,
  }) async {
  ...
  static Future<TournamentDTO> getTournamentByTeamId(
    RegionValues region,
    String teamId, {
    Map<String, String>? headers,
  }) async {
    ...
    TournamentDTO tournament = await ApiUtil.requestApi(
      url,
      TournamentDTO.fromJson,
      headers,
    );
    return tournament;
  }
  ...
  static Future<TournamentDTO> getTournamentById(
    RegionValues region,
    String tournamentId, {
    Map<String, String>? headers,
  }) async {
