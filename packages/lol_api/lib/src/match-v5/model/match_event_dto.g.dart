...
Map<String, dynamic> _$MatchEventDTOToJson(MatchEventDTO instance) =>
    <String, dynamic>{
      'realTimestamp': instance.realTimestamp,
      'timestamp': instance.timestamp,
      'eventType': _$TimlineEventTypeEnumMap[instance.eventType]!,
      'itemId': instance.itemId,
      'participantId': instance.participantId,
      'levelUpType': instance.levelUpType,
      'skillSlot': instance.skillSlot,
      'creatorId': instance.creatorId,
      'wardType': instance.wardType,
      'level': instance.level,
      'assistingParticipantIds': instance.assistingParticipantIds,
      'bounty': instance.bounty,
      'killStreakLength': instance.killStreakLength,
      'killerId': instance.killerId,
      'position': instance.position,
      'victimDamageDealt': instance.victimDamageDealt,
      'victimDamageReceived': instance.victimDamageReceived,
      'victimId': instance.victimId,
      'killType': instance.killType,
      'laneType': instance.laneType,
      'teamId': instance.teamId,
      'multiKillLength': instance.multiKillLength,
      'killerTeamId': instance.killerTeamId,
      'monsterType': instance.monsterType,
      'monsterSubType': instance.monsterSubType,
      ...
      'name': instance.name,
      'shutdownBounty': instance.shutdownBounty,
