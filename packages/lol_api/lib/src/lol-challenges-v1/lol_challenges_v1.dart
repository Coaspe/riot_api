...
class LOLChallengesV1 {
  ...
  static Future<ChallengeConfigInfoDTO> getSingleChallengeConfig(
    ...
    ChallengeConfigInfoDTO challenge = await ApiUtil.requestApi(
      url,
      ChallengeConfigInfoDTO.fromJson,
      headers,
    );
    return challenge;
  }
  ...
  static Future<List<ApexPlayerInfoDTO>> getTopPlayersOfLevel(
    ...
    final topPlayersEachLevel =
        await ApiUtil.requestApi<List<ApexPlayerInfoDTO>, List<dynamic>>(
          url,
          (json) => json
  ...
  static Future<LevelToPercentile> getMapOfLevelToPercentile(
    ...
    LevelToPercentile mapVal = await ApiUtil.requestApi(
      url,
      LevelToPercentile.fromJson,
      headers,
    );
    return mapVal;
  }
