...
KillDTO _$KillDTOFromJson(Map<String, dynamic> json) => KillDTO(
  timeSinceGameStartMillis: (json['timeSinceGameStartMillis'] as num).toInt(),
  timeSinceRoundStartMillis: (json['timeSinceRoundStartMillis'] as num).toInt(),
  killer: json['killer'] as String,
  victim: json['victim'] as String,
  victimLocation: LocationDTO.fromJson(
    json['victimLocation'] as Map<String, dynamic>,
  ),
